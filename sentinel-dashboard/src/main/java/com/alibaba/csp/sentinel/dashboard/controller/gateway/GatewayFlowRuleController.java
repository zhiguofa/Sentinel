...
public class GatewayFlowRuleController {
    ...
    private NacosRepositoryManager<GatewayFlowRuleEntity> repositoryManager;

    @PostConstruct
    void init() {
        this.repositoryManager = new NacosRepositoryManager<>(configService,  NacosConfigUtil.FLOW_DATA_ID_POSTFIX, GatewayFlowRuleEntity.class);
    }
    ...
    public Result<List<GatewayFlowRuleEntity>> queryFlowRules(String app, String ip, Integer port) {
        ...
        try {
            RuleRepository<GatewayFlowRuleEntity, Long> repository = repositoryManager.getRuleRepository(app);
    ...
    public Result<Long> deleteFlowRule(Long id, String app) {
