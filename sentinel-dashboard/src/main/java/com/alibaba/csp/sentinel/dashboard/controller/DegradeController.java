...
public class DegradeController {
    ...
    private NacosRepositoryManager<DegradeRuleEntity> repositoryManager;
    ...
    @PostConstruct
    public void init() {
        this.repositoryManager = new NacosRepositoryManager<>(configService, NacosConfigUtil.DEGRADE_FLOW_SUFFIX, DegradeRuleEntity.class);
    }
    ...
    public Result<List<DegradeRuleEntity>> apiQueryMachineRules(String app, String ip, Integer port) {
        ...
        try {
            RuleRepository<DegradeRuleEntity, Long>  repository = repositoryManager.getRuleRepository(app);
    ...
    public Result<DegradeRuleEntity> apiAddRule(@RequestBody DegradeRuleEntity entity) {
        ...
        try {
            RuleRepository<DegradeRuleEntity, Long>  repository = repositoryManager.getRuleRepository(entity.getApp());
    ...
    public Result<Long> delete(@PathVariable("id") Long id, String app) {
        if (id == null) {
